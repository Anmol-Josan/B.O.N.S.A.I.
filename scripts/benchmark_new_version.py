"""Compare the new modular BONSAI continual-learning variants on image tasks."""
...
from src.bonsai.evaluation import run_modular_image_comparison


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--output", type=Path, default=Path("results/new_version_image_comparison_5seed.json")
    )
